...
export class JCClient extends Adapter.Server<JustChatBot> {
    // @ts-ignore
    private internal: JC.JustChatClient;

    public createClient(config: JC.ClientConfig){
        this.internal = new JC.JustChatClient(config);
    }
